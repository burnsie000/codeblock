...
const Pricing: React.FC<PricingProps> = ({productOne, productTwo, productThree, productOnePrice, productTwoPrice, productThreePrice, productOneIncludes, productTwoIncludes, productThreeIncludes}) => {
    productOneIncludes = ['NextJS website that is optimized for SEO.', 'Up to 200 Web Pages.', 'Server Setup', 'Under 0.5 Second First Contentful Paint.', 'Website Design.', 'Responsive Design.', 'Mobile-Friendly.', 'Interactive Media.', 'SSL Certificate.', 'UX Design.', 'SAAS Application.', 'SAAS Website.', 'Fullscale Product.', 'Minimum Viable Product.']
    productTwoIncludes = ['NextJS website that is optimized for SEO.', 'Up to 1,000 Web Pages.', 'Server Setup', 'Under 0.5 Second First Contentful Paint.', 'Website Design.', 'Responsive Design.', 'Mobile-Friendly.', 'Interactive Media.', 'SSL Certificate.', 'UX Design.', 'Professional Copywriting Matter (Topic and Keyword Research)']
  ...
  return (
    <div className='flex flex-1 relative w-full px-9 h-full justify-center items-center bg-gradient-radial from-primary from-0% to-[rgb(20,20,20)] to-25% lg:to-50% text-center flex-col md:space-y-10 space-y-6 py-16 md:px-24 '>
        <div className='flex flex-col md:flex-row justify-between relative items-center space-y-8 md:space-y-0 lg:space-x-24'>
            ...
            <div className='flex relative w-full h-full px-2 py-4 flex-col md:flex-row items-center text-center justify-between space-y-2 md:space-y-4 xl:space-y-6'>
                <div className='w-full border-4 border-primary h-full 2xl:h-[40rem] flex flex-col transition-all ease-in-out hover:transition-all hover:ease-in-out hover:scale-110 relative items-center justify-center text-center mx-auto px-2 md:px-4 xl:px-6 py-4 md:py-8 xl:py-12 bg-[rgb(20,20,20)] bg-opacity-40 backdrop-filter backdrop-blur-xl shadow-neon rounded-3xl md:shadow-neon-lg xl:shadow-neon-xl space-y-4 md:space-y-8 xl:space-y-12'>
                    ...
                    <p className='flex relative items-start w-full justify-start text-left font-regular text-md md:text-lg xl:text-lg text-white'><strong className='font-semibold text-primary'>Development Cost / Project Cost:{' '}</strong>{productTwoPrice}</p>
                    <label className='flex relative items-start justify-start w-full px-6 lg:px-0 font-semibold text-lg text-primary'> Includes:</label>
                    <ul className='items-start flex-col justify-start flex relative'>
